...
const { createDriverSchema, updateDriverSchema ,validateLogin } = require('../middleware/validators/driverValidator.middleware');


router.get('/',auth(),  awaitHandlerFactory(driverController.getAllOrders)); // localhost:3000/api/v1/users
...
router.post('/login', validateLogin, awaitHandlerFactory(driverController.driverLogin)); // localhost:3000/api/v1/users/login
